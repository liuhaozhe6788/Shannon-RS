...
def cleaned_data_vis(cleaned_data_file):
    ...
    # 用户数量、物品数量、点赞用户数量、存在图片信息的动态数量、点赞行为的数量、用户-物品点赞行为的稀疏度
    ...
    dynamics_item_with_pic_df_ = dynamics_item_df_[dynamics_item_df_["image_url"] != "*"]
    ic(len(dynamics_item_with_pic_df_))
