...
class UI(QWidget):
    def __init__(self, db=None, parent=None):
        ...
        self.item_cf = ItemCF(self.db, "item_cf_top_n_recommendation_map.feather")
        self.item_cf.get_top_n()
        self.user_cf = UserCF(self.db, "user_cf_top_n_recommendation_map.feather")
        self.user_cf.get_top_n()
        self.hybrid_cf = HybridCF(self.db, "hybrid_cf_top_n_recommendation_map.feather")
        ...
        self.hybrid_cf_prompt = QLabel("基于用户和基于广义的混合协同过滤给您推荐如下动态: ")
