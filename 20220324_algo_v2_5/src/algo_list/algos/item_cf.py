...
class ItemCF():
    ...
    def __init__(self, database, train_data=None, test_flag=False):
        self.usr = None
    ...
    def run_item_cf(self, usr):
        ...
        basic = Base(self.usr, self.database, self.train_data, self.test_flag)
        gama, n_gama = basic.rearrangement(top_n_items, len(top_n_items))
