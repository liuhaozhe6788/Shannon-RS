...
__all__ = ["src_folder_path", "data_folder_path", "qt_img_folder_path",  "buffer_files_folder_path", "visualization_folder_path", "algo_result_folder_path",
           "perf_result_folder_path", "rec_result_folder_path"]
