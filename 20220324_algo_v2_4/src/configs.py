...
qt_vid_folder_path = os.path.join(root_folder_path, "vid")
...
__all__ = ["src_folder_path", "data_folder_path", "qt_img_folder_path", "qt_vid_folder_path", "visualization_folder_path", "algo_result_folder_path",
