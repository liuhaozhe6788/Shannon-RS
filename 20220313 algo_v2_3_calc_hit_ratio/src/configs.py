...
perf_result_img_folder_path = os.path.join(algo_result_folder_path, "perf_result")
...
__all__ = ["src_folder_path", "data_folder_path", "visualization_folder_path", "algo_result_folder_path",
           "perf_result_img_folder_path", "rec_result_folder_path", "view_img_folder_path",
